...
public class AbsorbParticleSpawner implements CustomParticleStatusEffect.Spawner {
    public static final ParticleGroup particles = ParticleGroupBuilder
            .magic(SpellEngineParticles.magic_spark, ParticleGroup.Motion.DECELERATE, Color.HOLY)
            .batch(b -> b.shape(ParticleGroup.Shape.PIPE).widthFactor(2F)
                    .count(5).speed(0.1F, 0.1F).verticalOrigin(Batches.FEET));
