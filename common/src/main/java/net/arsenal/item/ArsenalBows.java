...
public class ArsenalBows {
    ...
    public static RangedWeapon.Entry unique_longbow_1 = addBow(RangedWeapons.longBow(ArsenalMod.NAMESPACE, "unique_longbow_1", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_GOLD_BLOCK)
    ...
    public static RangedWeapon.Entry unique_longbow_2 = addBow(RangedWeapons.longBow(ArsenalMod.NAMESPACE, "unique_longbow_2", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_NETHERITE_SCRAP)
    ...
    public static RangedWeapon.Entry unique_longbow_sw = addBow(RangedWeapons.longBow(ArsenalMod.NAMESPACE, "unique_longbow_sw", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_GOLD_BLOCK)
    ...
    public static RangedWeapon.Entry unique_heavy_crossbow_1 = addCrossbow(RangedWeapons.heavyCrossbow(ArsenalMod.NAMESPACE, "unique_heavy_crossbow_1", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_NETHERITE_SCRAP)
    ...
    public static RangedWeapon.Entry unique_heavy_crossbow_2 = addCrossbow(RangedWeapons.heavyCrossbow(ArsenalMod.NAMESPACE, "unique_heavy_crossbow_2", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_BONE_BLOCK)
            ...
            .lootTheme(Loot.Theme.EVIL.toString()));
    public static RangedWeapon.Entry unique_heavy_crossbow_sw = addCrossbow(RangedWeapons.heavyCrossbow(ArsenalMod.NAMESPACE, "unique_heavy_crossbow_sw", Equipment.Tier.TIER_5, ArsenalItemTags.REPAIRS_GOLD_BLOCK)
